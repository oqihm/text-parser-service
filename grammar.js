...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c20 = "Value",
      peg$c21 = peg$literalExpectation("Value", false),
      peg$c22 = function(name, dataType, mandatory, hidden, value, list) {
            return {
              name: name,
              dataType: dataType,
              mandatory: mandatory,
      ...
      peg$c56 = function(calculations) {
            return calculations;
          },
      peg$c57 = "Calculation",
      peg$c58 = peg$literalExpectation("Calculation", false),
                                              ...
                                              if (s22 !== peg$FAILED) {
                                                ...
                                                if (s23 !== peg$FAILED) {
                                                  ...
                                                  if (s24 !== peg$FAILED) {
                                                    ...
                                                    if (s25 !== peg$FAILED) {
                                                      peg$savedPos = s0;
                                                      s1 = peg$c22(s4, s9, s13, s17, s22, s25);
                                                      s0 = s1;
                                                    } else {
                                                      peg$currPos = s0;
                                                      s0 = peg$FAILED;
